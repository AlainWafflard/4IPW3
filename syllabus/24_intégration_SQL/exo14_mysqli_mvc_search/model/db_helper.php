...
/**
 * pour récupérer l'ensemble des parties 
 * @param search_word 
 * @return array associative array with all deals
 */
function db_fetch_deals($search_word)
{
	global $conn, $message;

	try 
	{
		// construire la requête sur base des mots-clés
		if( ! empty($search_word))
		{
			...
			$q = <<< SQL
				...
				AND name_dea LIKE "%$search_word%"
				ORDER BY name_dea ASC;
SQL;
		}
		else
		{
